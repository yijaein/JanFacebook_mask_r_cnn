...
parser.add_argument('--data', default='/home/bong07/lib/robin_yonsei2/results_mrcnn/Seg_aug2_20181219T111320/M2_dataset/CropKidneyShapeWithColor', help='path to dataset')
...
parser.add_argument('--resume', default='~/data/yonsei2/models/M2_classification_kidney/result_CropKidneyShapeWithColor/checkpoint_70.pth', type=str, help='path to latest checkpoint')
parser.add_argument('--evaluate', default=True, action='store_true', help='evaluate model on validation set')
parser.add_argument('--seed', default=None, type=int, help='seed for initializing training')
parser.add_argument('--result', default='/home/bong07/lib/robin_yonsei2/results_mrcnn/Seg_aug2_20181219T111320/M2_result/result_CropKidneyShapeWithColor', help='path to result')
